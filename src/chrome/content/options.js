/* global InstantFox, dump, InstantFoxModule, Cu, 
    gNavigatorBundle, Services, gBrowser, openLinkIn,
    nsContextMenu, content, Components */
/*jshint asi:true*/    
var Cc = Components.classes;
var Ci = Components.interfaces;

Components.utils.import("resource://gre/modules/Services.jsm");
var ibp = Components.utils.import('chrome://instantfox/content/instantfoxModule.js')
...
var initEditPopup = function(plugin, panel){
    if(plugin)
...
var createEmptyPlugin = function() {
    var i=0;
...
var openEditPopup = function(item, anchor){
...
function saveGPlugin(createNew){
...
var canResetProp = function(el, plugin){
...
var resetPluginProp = function(self){
...
var toggleVisibility = function(el, selector, on){
...
var onTextboxInput = function(el){
    var id = $parent(el).id
...
var onTextboxEnter = function(el){
    var id = $parent(el).id
    InstantFoxModule.Plugins[id].key = el.value
    ibp.pluginLoader.initShortcuts()
    markConflicts()
...
var updateToolbarItems = function(){
...
var onOptionsPopupShowing = function(){
    rebuild()
...
var resetAllPlugins = function(proceed) {
